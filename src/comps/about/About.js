...
function About() {
    return (
        <div className="about-container">
            ...
            <p>A Pomodoro clock can be used to break time spent working on a task into intervals of 25 minutes 
                followed by small breaks of 5 minutes</p>
            <ol>        
                ...
                <li>If you have fewer than four checkmarks, take a short break (3–5 minutes) and
